...
## Development environment and release process
 ...
 - create virtualenv with Flask and Shiftry installed into it (latter is installed in
...
install it (`pip install hseling_api_diachrony_webvectors.tar.gz`), ensure that configuration file exists and
`HSELING_API_DIACHRONY_WEBVECTORS_SETTINGS` environment variable points to it, ensure that user has access to the
